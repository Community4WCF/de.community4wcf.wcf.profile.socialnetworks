...
/*
 * Implements an XING Profilefield
 * @package		de.community4wcf.wcf.profile.socialnetworks.business
*/
 
class UserOptionOutputXING implements UserOptionOutput, UserOptionOutputContactInformation {
	protected $type = 'xing';
	...
	*/
	public function getURL() {
		return $url = 'https://www.xing.com/profile/';
	}
