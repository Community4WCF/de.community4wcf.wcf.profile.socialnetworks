...
/*
 * Implements an GooglePlus Profilefield
 * @package		de.community4wcf.wcf.profile.socialnetworks
*/
 
class UserOptionOutputGooglePlus implements UserOptionOutput, UserOptionOutputContactInformation {
	protected $type = 'google.plus';
	
	/*
	 * getURL from Options
	*/
	public function getURL() {
		switch (USER_GOOGLEPLUS_URL_SELECT) {
			case 'GOOGLEPLUS':
				$url = 'https://plus.google.com/';
				break;
		
			case 'TOGPLUSCOM':
				$url = 'http://togplus.com/';
				break;
